---
description: Dans cette mise en pratique, nous allons voir l'intérêt du Polymorphisme. Le polymorphisme est le fait qu'une classe mère peut prendre plusieurs formes (poly = plusieurs, morphisme = forme).
---
...
Dans cette mise en pratique, nous allons voir l'intérêt du Polymorphisme. Le polymorphisme est le fait qu'une classe mère peut prendre plusieurs formes (**poly** : plusieurs, **morphisme** : forme). Avec le polymorphisme nous pouvons donc écrire sans que cela pose problème :
...
Écrire les classes nécessaires au fonctionnement du programme suivant. Pour cet exercice, vous ne fournirez que les méthodes nécessaires au fonctionnement.
...
- Réfléchissez à la modélisation UML.
  - Combien devons-nous créer de classes ?
- Comment est-ce possible de sauvegarder dans une même liste des objets de types différents ?
