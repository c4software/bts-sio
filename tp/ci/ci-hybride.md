...
Pour déclarer un runner c’est très simple, il faut juste le lancer / l’installer sur votre machine. La documentation de GitLab étant très bien faite, rendez-vous [ici pour Windows](https://docs.gitlab.com/runner/install/windows.html) et [là pour Linux](https://docs.gitlab.com/runner/install/linux-repository.html).
...
✋ STOP ! Une fois rendu à cette étape, appelez-moi ! Nous allons terminer la procédure ensemble. Pour les plus téméraires, vous pouvez suivre [la documentation](https://docs.gitlab.com/runner/register/index.html#windows) (attention à bien choisir Docker).
