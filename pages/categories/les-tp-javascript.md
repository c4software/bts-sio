---
aside: false
description: La liste des TP JavaScript (des bases jusqu'à VueJS) dans l'ordre dans lequel je vous conseille de les réaliser.
---
...
1. [Prise en main VueJS 3](/tp/vuejs3/tp0.md)
2. [Suite prise en main VueJS 3](/tp/vuejs3/tp1.md)
3. [Découverte de ViteJS](/tp/vuejs3/vite.md)
