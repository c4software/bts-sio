...
Vous trouverez ici la liste des TP « avancés » du PHP, dans l'ordre dans lequel je vous conseille de les réaliser. Ce parcours prend la suite [des TP PHP de base](/pages/categories/les-tp-php-de-base.md) : la structure, les formulaires, la session, la base de données et les premières classes (la partie [PHP et POO](/pages/categories/les-tp-php-de-base.md#etape-4-php-et-poo)) doivent être acquis avant de commencer.
