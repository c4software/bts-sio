module.exports = {
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      { collapsable: false, title: "Framework Javascript", children: ["cours/framework_javascript", "/tp/javascript_avances/introduction.md", "/tp/vuejs/tp1.md", "/tp/vuejs/firebase-vuejs.md"] },
