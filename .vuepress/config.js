module.exports = {
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      { collapsable: true, title: "Introduction HTML", children: ["cours/introduction_html"] },
      ...
      { collapsable: true, title: "Programmation sécurisée avec OWASP", children: ["cours/securite_applications", "cours/introduction_securite", "tp/securite/"] },
      ...
      { collapsable: true, title: "Android", children: ["cours/android", "/tp/android/app-ble-network", "/tp/android/sample-explication"] }
    ]
  }
};
