    ...
    children: [
      ...
      { text: "En + du cours", collapsible: true, children: ["/tp/devops/serveur/support.md", "/tp/devops/support-docker-cicd.md"] },
      {
        text: "Les TP", collapsible: true, children: [
          { text: "La base", collapsible: true, children: ["/tp/devops/serveur/tp1.md", "/tp/devops/serveur/tp1alt.md", "/tp/devops/serveur/tp1b.md", "/tp/devops/serveur/tp1c.md", "/tp/devops/serveur/tp2.md", "/tp/devops/serveur/tp3.md", "/tp/devops/serveur/tp4.md"] },
